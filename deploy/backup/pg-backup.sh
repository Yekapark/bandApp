...
R2_BUCKET=$(envget R2_BUCKET); R2_ENDPOINT=$(envget R2_ENDPOINT); R2_ACCOUNT_ID=$(envget R2_ACCOUNT_ID)
R2_ACCESS_KEY_ID=$(envget R2_ACCESS_KEY_ID); R2_SECRET_ACCESS_KEY=$(envget R2_SECRET_ACCESS_KEY)
: "${DB_NAME:?}" "${DB_USERNAME:?}"
