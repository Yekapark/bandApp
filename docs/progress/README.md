...
| 12 | [phase-12-iap.md](phase-12-iap.md) — 인앱결제(Google Play, Android): 구매 토큰 검증(`/plan/google/verify`) · RTDN 웹훅(갱신·해지·환불, 멱등) · `StoreBillingGateway` 재설계 + no-op/Google 어댑터 · 웹훅 OIDC·공유시크릿 인증 · Flutter `in_app_purchase` 결제 UI · 환불(REVOKED) 즉시 강등 | ✅ 완료 — PR #69·#70·#71·#83 · CI 통과. 실기기 실결제로 구매·해지·만료·환불(type 12 → 즉시 FREE) 전부 확인 (2026-09-09) |
