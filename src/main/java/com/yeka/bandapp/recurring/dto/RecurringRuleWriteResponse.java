...
/**
 * 정기 일정 규칙 등록 응답. 규칙과 함께 이번에 만들어진 회차 목록, 그리고 그 회차들과 시간대가 겹치는
 * 기존 일정({@code overlaps})을 담는다. {@code overlaps}가 비어 있지 않아도 요청은 <b>성공</b>이다 —
 * 겹침은 경고이지 거부 사유가 아니다(BUILD_PLAN 2장 2번).
 */
